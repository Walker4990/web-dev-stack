...
public class D_Scanner {
	 ...
	 * 		- 정수일 때 : sc.nextInt() - 공백 있을 경우 공백 이전까지
	 * 		- 실수일 때 : sc.nextFloat(), sc.nextDouble() - 공백 있을 경우 공백 이전까지
	 * 
...
//		char gender = input.charAt(0);
		char gender = sc.nextLine().charAt(0); // 첫번째 글자 선택 
		
		System.out.println("당신의 이름은 " + name + 
							"이고 나이는 " + age +
							"살이고, 사는 곳은 " + addr +
							"키는" + height + "cm이고, 성별은" + gender +"입니다.");
//		printf 사용
//		당신의 이름은 김미역이고 나이는 1살이고, 사는 곳은 서울키는100.0cm이고, 성별은여입니다.
		System.out.printf("당신의 이름은 %s이고 나이는 %d이고, 사는 곳은 %s이며, 키는 %.1fcm이며 성별은 %c입니다.", name, age, addr, height, gender);
