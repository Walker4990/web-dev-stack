...
public class C_Sorting {
	...
	public void method1() {
		...
		// 1. 오름차순 정렬(작은 숫자 ~ 큰 숫자)
		Arrays.sort(arr);
		System.out.println(Arrays.toString(arr));

		// 2. 내림차순 정렬 -> 원본 배열은 따로 있고, 새로운 배열을 생성해서 거꾸로 나오게끔.
	 ...
	 * 실제로는 Arrays.sort() 같은 내장 정렬이나 Collecctions.sort()가 훨씬 빠르고
	 * 실용적이기 때문에 몰라도 된다. 근데 정처기에 나온다..
	 * */
