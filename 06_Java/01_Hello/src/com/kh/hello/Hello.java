...
/*
 * 클래스(class)
 * - 자바에서 모든 코드는 반드시 클래스 안에 존재해야 하며 서로 관련된 코드들을 그룹으로 나누어 별도의 클래스를 운영한다.
...
public class Hello { // 클래스명은 클래스 파일명과 동일해야 한다.
	 ...
	 * - 해당 메서드 호출 시 메서드의 블럭({})에 헤당하는 부분을 실행한다.
	 * */
	...
	public static void main(String[] args) {
		 ...
		 * - 클래스명 : 대문자로 시작, 여러 개의 단어가 있을 때에는 단어 앞자리마다 그 문자
		 * - method명 : 소문자로 시작, 여러개의 단어가 있을 때에는 단어 앞자리마다 대문자
		 * */
	}
